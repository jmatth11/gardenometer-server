...
func ReadConfigForDevice(conn *sql.DB, name string) (*models.Config, error) {
...
func InsertConfigForDevice(conn *sql.DB, obj *models.Config) error {
...
func UpdateConfigForDevice(conn *sql.DB, obj *models.Config) error {
